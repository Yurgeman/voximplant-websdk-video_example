...
var EventTarget_1 = __webpack_require__(13);
...
var RemoteFunction_1 = __webpack_require__(3);
var RemoteEvent_1 = __webpack_require__(12);
var MsgSignaling_1 = __webpack_require__(14);
...
var VoxSignaling = function () {
    ...
    _createClass(VoxSignaling, [{
        ...
        value: function onConnectionSuccessfulRPC(token) {
            ...
            this.callRemoteFunction(RemoteFunction_1.RemoteFunction.switchProtocol, {});
...
(function (RemoteFunction) {
    ...
    //    =========================Push service
    //    =========================Data chanel
    RemoteFunction[RemoteFunction["switchProtocol"] = "switchProtocol"] = "switchProtocol";
    //    =========================Data chanel
...
Object.defineProperty(exports, "__esModule", { value: true });
var Call_1 = __webpack_require__(19);
...
var SignalingDTMFSender_1 = __webpack_require__(18);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Logger_1 = __webpack_require__(0);
var MsgEnums_1 = __webpack_require__(15);
var VoxSignaling_1 = __webpack_require__(2);
var EventTarget_1 = __webpack_require__(13);
/**
...
var SDPMuggle = function () {
    ...
    _createClass(SDPMuggle, [{
        ...
        value: function removeTIAS(sdp) {
            ...
            //         if(item.indexOf('b=TIAS')!==-1)
            //             removenumbers.unshift(index);
            //     });
            //     removenumbers.forEach((item)=>sdpLines.splice(item, 1));
            //     sdp = <RTCSessionDescription>{type:sdp.type,sdp:sdpLines.join('\r\n')+'\r\n'};
            // }
            return sdp;
        }
    }, {
    ...
    _createClass(PeerConnection, [{
        ...
        value: function startCandidateSendTimer() {
            ...
            if (this.candidateSendTimer === null || typeof this.candidateSendTimer === "undefined") {
                this.candidateSendTimer = setTimeout(function () {
                    _this2.candidateSendTimer = null;
                    if (_this2.pendingCandidates.length > 0) {
                        if (CallManager_1.CallManager.get().calls[_this2.id]) CallManager_1.CallManager.get().calls[_this2.id].sendInfo(Constants_1.Constants.P2P_SPD_FRAG_MIME_TYPE, JSON.stringify(_this2.pendingCandidates), {});
                    }
                    _this2.pendingCandidates = [];
        ...
        value: function sendMedia(audio, video) {
            ...
            return new Promise(function (_resolve, reject) {
                ...
                _this3.reInviteQ.add({ fx: function fx() {
                        var appConfig = Client_1.Client.getInstance().config();
                        index_1.default.StreamManager.get().updateCallStream(_this3._call);
                    }, reject: reject, resolve: function resolve(e) {
                        _this3.restoreMute();_resolve(e);
                    } });
            });
        }
        /**
        ...
        */
        ...
        value: function hold(newState) {
            ...
            return new Promise(function (_resolve2, reject) {
                _this4.reInviteQ.add({ fx: function fx() {
                        _this4._hold(newState);
                    }, reject: reject, resolve: function resolve(e) {
                        _this4.restoreMute();_resolve2(e);
                    } });
            });
        }
    }, {
        ...
        value: function hdnFRS() {
            ...
            return new Promise(function (_resolve3, reject) {
                ...
                _this5.reInviteQ.add({ fx: function fx() {
                        _this5._hdnFRS();
                    }, reject: reject, resolve: function resolve(e) {
                        _this5.restoreMute();_resolve3(e);
                    } });
            });
        }
    }, {
        ...
        value: function muteMicrophone(newState) {
            ...
            index_1.default.StreamManager.get().getCallStream(this._call).then(function (stream) {
                stream.getAudioTracks().forEach(function (track) {
                    track.enabled = !_this6.muteMicState;
                });
            });
        }
    }, {
        ...
        value: function restoreMute() {
            ...
            if (this._call.settings.active) {
                var that = this;
                setTimeout(function () {
                    _this7._call.restoreRMute();
                    index_1.default.StreamManager.get().getCallStream(_this7._call).then(function (stream) {
                        stream.getAudioTracks().forEach(function (track) {
        ...
        value: function addCustomMedia(stream) {
            ...
            return new Promise(function (_resolve4, reject) {
                _this8.reInviteQ.add({
                    fx: function fx() {
                        _this8._addCustomMedia(stream);
                    }, reject: reject, resolve: function resolve(e) {
                        _this8.restoreMute();_resolve4();
                    }
                });
            });
        }
        ...
        value: function removeCustomMedia(stream) {
            ...
            return new Promise(function (_resolve5, reject) {
                _this9.reInviteQ.add({
                    fx: function fx() {
                        _this9._removeCustomMedia(stream);
                    }, reject: reject, resolve: function resolve(e) {
                        _this9.restoreMute();_resolve5();
                    }
                });
            });
        }
    ...
    _createClass(StreamManager, [{
        ...
        value: function onMirrorEnded() {
            ...
            this.getMirrorStream().then(function (stream) {
                _this9.dispatchEvent({ name: __1.default.HardwareEvents.MediaRendererRemoved, mediaRenderer: stream });
            });
        }
        /**
         * @hidden
...
var MediaRenderer = function () {
    ...
    kind) {
        ...
        if (this.stream.getTracks().length) {
            this.element = document.createElement(this.kind === 'sharing' ? 'video' : this.kind);
    ...
    _createClass(MediaRenderer, [{
        ...
        value: function renderDefault() {
            var containerId = this.isLocal ? Client_1.Client.getInstance().localVideoContainerId : Client_1.Client.getInstance().remoteVideoContainerId;
...
var AbstractEndpointManager = function () {
    ...
    _createClass(AbstractEndpointManager, [{
        ...
        value: function getDefaultEndPoint(call) {
            ...
            var defaultEndpoint = new Endpoint_1.Endpoint();
            defaultEndpoint.id = call.id();
            defaultEndpoint.isDefault = true;
        ...
        value: function addStreamToEndpoint(call, endpoint, stream) {
            if (endpoint.mediaRenderers && endpoint.mediaRenderers.some(function (renderer) {
                return renderer.stream.getTracks()[0].id === stream.getTracks()[0].id;
            })) return;
            var mediaType = 'video';
            if (stream.getTracks().length === 1) mediaType = this.getMediaTypeTrack(call, stream.getTracks()[0]);
            var mediaRenderer = new MediaRenderer_1.MediaRenderer(stream, mediaType, false);
        ...
        value: function addTrack(call, track) {
            this.addStream(call, new MediaStream([track]));
        }
    }, {
        key: "clear",
        value: function clear(call) {
            ...
            return new Promise(function (resolve, reject) {
                var endpointList = _this._endpointList[call.id()] || {};
                var _iteratorNormalCompletion = true;
                var _didIteratorError = false;
                var _iteratorError = undefined;
                ...
                delete _this._endpointList[call.id()];
                resolve();
            });
        }
        /**
        ...
        value: function endpointInfoUpdated(call, kind, message) {
            ...
            if (targetEndpoint && (kind == Constants_1.Constants.VI_CONF_PARTICIPANT_INFO_ADDED || kind === Constants_1.Constants.VI_CONF_PARTICIPANT_INFO_UPDATED)) {
                ...
                targetEndpoint.dispatchEvent({ name: EndpointEvents_1.EndpointEvents.InfoUpdated, call: call, endpoint: targetEndpoint });
            }
        ...
        value: function setEndpointDescription(call, description) {
            ...
            rmEndpoints.forEach(function (endpoint) {
                return _this2.deleteEndpoint(call, endpoint);
            });
            var trackListMap = {};
            var trackKindMap = {};
...
var Messenger_1 = __webpack_require__(16);
    ...
    _createClass(WebRTCPC, [{
        ...
        value: function enableVideo(flag) {
            ...
            this.impl['getLocalStreams']().forEach(function (stream) {
                stream.getVideoTracks().forEach(function (track) {
                    if (!_this14.shareScreenMedia || !_this14.shareScreenMedia.some(function (sStream) {
                        return sStream.getTracks().some(function (sTrack) {
                            return sTrack.id === track.id;
                        });
                    })) {
        ...
        value: function _addCustomMedia(stream) {
            ...
            if (BrowserSpecific_1.default.getWSVendor() === 'firefox') {
                stream.getTracks().forEach(function (track) {
                    ...
                    _this15.rtpSenders.push(_this15.impl.addTrack(track, newStream));
                ...
                if (this.impl.getTransceivers) {
                    ...
                    transceiverList.forEach(function (transceiver) {
                        if (stream.getTracks().find(function (track) {
                            ...
                            console.error('Transceiver stopped');
                            transceiver.stop();
                        }
                    });
                } else {
                    this.impl.getSenders().forEach(function (sender) {
                        if (stream.getTracks().indexOf(sender.track) !== -1) _this16.impl.removeTrack(sender);
                    });
                }
            } else {
        ...
        value: function _fixFFSoundBug() {
            ...
            if (BrowserSpecific_1.default.getWSVendor() === 'firefox' && PCFactory_1.PCFactory.hasTransceivers) {
                setTimeout(function () {
                    if (_this17.impl.getSenders) {
                        var senders = _this17.impl.getSenders();
...
var ZingayaAPI = function () {
  ...
  _createClass(ZingayaAPI, [{
    ...
    value: function requestMedia(video, onMediaAccessGranted, onMediaAccessRejected, stopStream) {
      ...
      // const mediaManager = UserMediaManager.get();
      // mediaManager.enableAudio(true);
      // mediaManager.queryMedia()
      //     .then((stream) => {
      //         UserMediaManager.get().updateLocalVideo(stream);
      //         if (typeof onMediaAccessGranted == "function")
      //             onMediaAccessGranted(stream);
      //     })
      //     .catch((err) => {
      //         if (typeof onMediaAccessRejected == "function")
      //             onMediaAccessRejected(err);
      //     });
    }
  }, {
    key: "hangupCall",
